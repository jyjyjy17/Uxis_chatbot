...
object callChatBot {
    fun main(
        ...
        var apiURL = "https://31255242dc0f4382a1b24a7ff3bc39d3.apigw.ntruss.com/custom/v1/3404/7bc7fbfd2d9a6111116c55aad1795f44aa5110805b6adce3c7ca2d7df1008a01"
        var secretKey = "YlFLZnpJQlNwWVNPdXFNbFJFb0x1WkNtZ3dqbE5JTWI="
        var chatbotMessage: String? = ""
        try {
            //String apiURL = "https://ex9av8bv0e.apigw.ntruss.com/custom_chatbot/prod/";
            val url = URL(apiURL)
            val message =
                getReqMessage(voiceMessage)
            println("##$message")
            val encodeBase64String =
                makeSignature(message, secretKey)
    ...
    fun makeSignature(message: String, secretKey: String): String {
        ...
        try {
            ...
            val signingKey =
                SecretKeySpec(secrete_key_bytes, "HmacSHA256")
